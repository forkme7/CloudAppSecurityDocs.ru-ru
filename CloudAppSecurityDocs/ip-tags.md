...
В строке меню щелкните значок параметров ![значок параметров](./media/settings-icon.png "значок параметров") и выберите пункт **Диапазоны IP-адресов**. Щелкните **+Добавить диапазон IP-адресов** и заполните следующие поля.  
...
4.  Введите значение **Зарегистрированный поставщик услуг Интернета**. Это переопределит данные в ваших действиях  
...
6.  **Категории IP-адресов** позволяют легко распознавать действия с интересных IP-адресов. Эти категории доступны на портале, но пользователь должен настроить их, указав включаемые в каждую из них IP-адреса. Исключение — категория "Рискованные", которая содержит два тега IP-адресов: "Анонимные прокси-серверы" и "Tor".  
