...
>[!NOTE]
> Если вы используете Symantec Vontu для проверки файлов из Dropbox, CAS автоматически указывает, что файл поступил с URL-адреса http://misc/<имя_файла>. Этот заполнитель URL-адреса никуда не ведет, но используется для журналов.
