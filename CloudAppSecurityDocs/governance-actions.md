---
title: "Система управления | Microsoft Docs"
...
Следующие действия управления могут применяться к определенным файлам, пользователям или из конкретной политики.
...
-   "Наследовать разрешения от родительского объекта" — это действие по управлению позволяет удалить набор разрешений, определенных для файла или папки, и задать вместо них разрешения родительской папки.
