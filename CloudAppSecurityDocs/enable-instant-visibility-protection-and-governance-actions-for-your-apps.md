---
title: "Включение мгновенной видимости, защиты и действий управления для приложений | Документы Майкрософт"
description: "В этом разделе описывается процесс включения соединителей API для приложений в облачной среде организации."
keywords: 
author: rkarlin
ms.author: rkarlin
manager: mbaldwin
...
# <a name="enable-instant-visibility-protection-and-governance-actions-for-your-apps"></a>Включение мгновенной видимости, защиты и действий управления для приложений
...
|**Сканирование файлов почти в реальном времени**|Ожидается в ближайшее время|✔|Не применяются|✔ — требует Google Unlimited|||Ожидается в ближайшее время||  
...
\* Соединитель приложений Office 365 включает в себя активность администратора для Exchange Online. Чтобы добавить активность пользователя для Exchange Online, необходимо развернуть соединитель Exchange Online отдельно.  
