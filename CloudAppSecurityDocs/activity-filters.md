...
Чтобы просмотреть дополнительные сведения о каждом действии, щелкните его в журнале действий. Откроется панель действий, на которой отображаются дополнительные действия, которые можно предпринять для действия.
...
Возможности анализа включают в себя встроенную функцию предоставления сведений об активном пользователе. На панели "Активность" можно одним щелчком получить подробные сведения о пользователе, чтобы узнать, помимо прочего, откуда он подключался, сколько открытых оповещений с ним связано, а также просмотреть его метаданные.
...
![Анализ данных пользователя в Cloud App Security](./media/user-insights.png)
