---
title: "Управление разрешениями приложения | Документы Майкрософт"
...
2. Затем на панели мониторинга Office 365 перейдите на вкладку **Разрешения приложения**.
...
1. В расширенном представлении сократите область поиска с помощью раскрывающегося списка **Выберите фильтр**. Дополните запрос, добавив операторы и проверки на равенство или неравенство для указанных значений.
