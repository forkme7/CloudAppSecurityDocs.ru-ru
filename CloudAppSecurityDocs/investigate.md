...
##  <a name="a-namesanctionappa-sanction-or-unsanction-apps"></a><a name="sanctionapp"></a> Применение или отмена санкционирования приложений  
...
-   В консоли Cloud App Security щелкните пункт **Обнаружение**, а затем — **Панель мониторинга обнаружения**.  

-   В списке обнаруженных приложений щелкните многоточие ![многоточие в строке приложения](./media/sanction-three-dots.png "Sanction three dots") в конце строки с приложением, которое нужно санкционировать, и выберите команду **Пометить как санкционированное**.  

     ![Пометить как санкционированное](./media/mark-as-sanctioned.png "mark as sanctioned")  
...
4.  Выберите **Сведения** и затем приложение. Откроется панель мониторинга приложений, на которой будут предоставлены сведения и ценная информация. Вы можете использовать вкладки сверху, чтобы проверить следующее.  
     ...
     ![Панель мониторинга приложений](./media/investigate-app.png "investigate app")  
...
5.  В разделе **Фильтры действий** щелкните **+** для добавления фильтра. Прокрутите страницу вниз до элемента **Тег IP-адреса**, а затем выберите пункты **Анонимный** и **Tor**.  
     ...
     ![Пример политики в отношении опасных IP-адресов](./media/example-policy-risky-ips.png "example policy risky ips")  
