...
##  <a name="a-namesanctionappa-tag-apps-as-sanctioned-or-unsanctioned"></a><a name="sanctionapp"></a> Отметка приложений как санкционированных или несанкционированных  
...
-   В списке приложений на строке с приложением, которое вы хотите отметить как санкционированное, выберите многоточие в конце строки ![многоточие "Отметить как санкционированное"](./media/sanction-three-dots.png "Tag as sanctioned dots") и выберите **Отметить как санкционированное**.  

     ![Отметка приложения как санкционированного](./media/mark-as-sanctioned.png "tag as sanctioned")  
