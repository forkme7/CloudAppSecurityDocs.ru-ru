...
**Новые возможности**
-   Доступна [анонимизация данных](cloud-discovery-anonymizer.md), благодаря которой вы сможете пользоваться Cloud Discovery, защитив конфиденциальность пользователей. Анонимизация данных осуществляется путем шифрования имен пользователей.
...
**Устранение ошибок**
-   Файлы SPO и OD4B в отчете о политике обработки файлов и на странице Files (Файлы) имеют состояние Internal (Внутренний), а не Private (Частный). Эта ошибка была исправлена.
