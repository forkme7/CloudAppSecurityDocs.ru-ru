---
title: "Заметки о выпуске для Cloud App Secuirty и ее версии | Microsoft Docs"
...
**Новые возможности**
-    Начинается развертывание возможности видеть события DLP Центра безопасности и соответствия требованиям Office 365 в Cloud App Security. Если политики DLP настроены в этом Центре, обнаруженные совпадения с ними можно будет увидеть в журнале действий Cloud App Security. В журнале действий будут указаны такие данные, как файл или электронное письмо, инициировавшее срабатывание, и политика или оповещение, которое сработало. Действие "Событие безопасности" позволяет просматривать объекты, активировавшие политики Office 365 DLP, в журнале действий Cloud App Security. При помощи этой функции можно:
