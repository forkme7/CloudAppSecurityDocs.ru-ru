...
3. Задайте значение для параметра **Серьезность политики**. Вы можете задать в Cloud App Security уровни серьезности и настроить в них отправку предупреждений при срабатывании политики.
