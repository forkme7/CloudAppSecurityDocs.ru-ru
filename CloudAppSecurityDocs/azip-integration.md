...
Сейчас эта функция доступна для файлов, которые хранятся в Box, SharePoint Online и OneDrive для бизнеса. В будущих версиях будут поддерживаться и другие облачные приложения.
