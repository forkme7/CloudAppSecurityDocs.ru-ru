...
Сейчас Cloud App Security поддерживает только универсальный уровень защиты. Собственная защита для файлов Office, PDF и файлов изображений будет доступна в будущих версиях. 
...
2. Вам будет предложено выбрать один из шаблонов вашей организации для защиты файла, после чего следует щелкнуть **Защита**. 
![Шаблон защиты](./media/protect-template.png)
3. Когда вы выберете шаблон и щелкнете "Защита", Cloud App Security применит шаблон и обеспечит защиту исходного файла. Защищенный файл будет иметь то же самое имя, что и исходный файл, но с новым расширением PFILE.
> [!NOTE]
>     Рекомендуется применять для файлов шаблоны RMS корпоративного уровня, чтобы все пользователи в организации могли получать доступ к ним, в том числе и владелец исходного файла. Владелец файла, политика совместного использования файла и список пользователей, уже имеющих доступ к нему, не меняются, когда файл становится защищенным.
