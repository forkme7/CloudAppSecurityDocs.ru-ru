...
4. Выберите команду **Создать**.
 ...
 Теперь вы можете использовать теги IP-адресов при создании политик, фильтрации и создании представлений данных.

 **Создание представлений**

1. Выберите **Параметры** > **Параметры Cloud Discovery**.
2. В разделе **Представления данных** щелкните пункт (+) **Добавить представление данных**.
