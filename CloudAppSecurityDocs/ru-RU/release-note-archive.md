...
- Улучшена обработка внешних пользователей в SharePoint Online. При фильтрации по группе "внешние пользователи" системная учетная запись @"sharepoint" отображаться не будет.
