...
3. Создайте фильтр для приложений, которые требуется отслеживать, щелкнув <strong>Add filter</strong> (Добавить фильтр). 
   Выберите определенное приложение, <strong>категорию</strong> приложения или отфильтруйте приложения по <strong>названию</strong>, <strong>домену и **коэффициенту риска</strong> и нажмите кнопку <strong>Сохранить</strong>.
