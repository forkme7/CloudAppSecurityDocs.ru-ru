...
|![значок политики поля](./media/field_policy.png)|Политика поля|Политики полей позволяют проверять облачные приложения на наличие полей в облачной среде, которые могут содержать конфиденциальные данные, такие как публикации, сообщения чата, описания и длинные текстовые поля.|  
