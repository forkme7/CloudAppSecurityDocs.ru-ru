...
-   Метка классификации — поиск файлов с определенными тегами, назначенными службой Azure Information Protection. Для работы этой функции требуется интеграция с Azure Information Protection.
